...
<div align="center">
  <table width="500" border="0" align="left">
    <tr>
      ...
      </div>        <form ACTION="<?php echo $loginFormAction; ?>" name="form1" method="POST">
          <div align="center">
            <table width="450" border="0" bgcolor="#FFCC66">
              <tr>
                <td width="362"><div align="center"><span class="style5">請輸入您的身份證字號：</span>
                        <input name="IDnumber" type="text" id="IDnumber22" size="25" maxlength="10">
                </div></td>
  ...
  確認結果：<span class="style2">咦？找不到你耶，趕快 <a href="notice.htm">再報名一次</a> 吧！</span></span></p>
        <p align="center">&nbsp;</p>
