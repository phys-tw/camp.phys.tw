...
//  echo "Select * From 2k07_list" . $p_SQL ;
  ...
  */
  ...
  echo "<script language=\"javascript\">function newpage() {document.form.submit();}</script><form name=\"form01\" method=\"post\" action=\"sysop_edit.php\" target=\"newpage\" ><input type=\"text\" name=\"no\"><input type=\"hidden\" name=\"password\" value=\"physland\"><input type=\"button\" onclick=\"newpage()\" value=\"送出\"></form>";
