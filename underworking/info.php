...
<div id="container">
	...
	<div id="content">
		...
		<div id="intro">
			<h2>活動資訊</h2>
			<div class="info_item"><h3>活動對象</h3><span class="info_span">全國高中學生 100 人</span></div>
			<div class="info_item"><h3>活動日期</h3><span class="info_span">2014/1/22~2014/1/26，共計五天四夜</span></div>
			<div class="info_item"><h3>活動地點</h3><span class="info_span">國立台灣大學物理新館暨凝態科學館</span></div>
			<div class="info_item"><h3>住宿地點</h3><span class="info_span">台大綜合體育館B1選手村（台北市羅斯福路四段一號）</span></div>
			<div class="info_item"><h3>活動費用</h3><span class="info_span" style="display:block;width:80%;text-indent:0px;margin-left:15px;margin-bottom:15px;">
				5000<br />
				費用採匯款方式，將於 2013/12/6 (五)公佈正取名單並以E-mail通知匯款方式。匯款時間為一星期，逾期名額將由候補依序遞補</span></div>
			<div class="info_item"><h3>報名方式</h3><span class="info_span">統一網路報名；報名截止日期12/6</span></div>
			<h3>活動流程</h3>
			<div id="tbl_wrap">
			<table id="info_table">
				<tr>
