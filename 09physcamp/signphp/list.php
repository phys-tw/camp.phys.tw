...
//  echo "Select * From $dataTableName" . $p_SQL ;
  ...
  echo "<p style='margin-left: 135px; margin-bottom: 4px; margin-top: 30px'>" ;
  ...
  while ($fetch_Assoc = $db->fetchAssoc()) {
	...
	echo "<td width='17' style='background-color: ", $background, "'><a href='Javascript:' onClick=\"window.open('view.php?no=", $fetch_Assoc['AutoNo'], "', '', 'width=1002,height=300,scrollbars=no,resizable=yes');\"><img src='images/browse.png' width='16' height='16' border='0' alt='查看完整資料'></a></td>" ;
	echo "<td width='17' style='background-color: ", $background, "'><a href='Javascript:' onClick=\"window.open('sysop_edit.php?no=", $fetch_Assoc['AutoNo'], "', '', 'width=744,height=262,scrollbars=no,resizable=no');\"><img src='images/edit.png' width='16' height='16' border='0' alt='編輯特定欄位'></a></td>" ;
	if ($fetch_Assoc['State'] != 9)
	  echo "<td width='17' style='background-color: ", $background, "'><a href='Javascript:' onClick=\"window.open('sysop_delete.php?no=", $fetch_Assoc['AutoNo'], "', '', 'width=354,height=80,scrollbars=no,resizable=yes');\"><img src='images/delete.png' width='16' height='16' border='0' alt='刪除此筆資料'></a></td>" ;
	else
	  echo "<td width='17' style='background-color: ", $background, "'><a href='Javascript:' onClick=\"window.open('sysop_un_delete.php?no=", $fetch_Assoc['AutoNo'], "', '', 'width=354,height=80,scrollbars=no,resizable=yes');\"><img src='images/un_delete.png' width='16' height='16' border='0' alt='恢復此筆資料'></a></td>" ;
	if ($fetch_Assoc['State'] != 9) {
	...
	echo "<td width='60' style='background-color: ", $background, "'><a href='Javascript:' onClick=\"window.open('view.php?no=", $fetch_Assoc['AutoNo'], "', '', 'width=1002,height=300,scrollbars=no,resizable=yes');\">", $fetch_Assoc['Name'], "</a></td>" ;
