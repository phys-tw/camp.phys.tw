...
?>
    ...
    <form method="post" action="board_write.php?submit=1" onsubmit="return msgcheck();">
    <p>姓名：<input name="name" id="name" <?php echo ($auth? 'value="物理營幹部" disabled':''); ?> /></p>
    <p><textarea name="message" id="message" style="display:none;"></textarea><textarea name="msg2984ut8t2" id="msg2984ut8t2" style="width: 600px; height: 100px;"><?php echo $oldreply; ?></textarea></p>
