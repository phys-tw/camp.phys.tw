...
if ($messenge != "") {
  ...
  echo "<p align='center'><a href='#' onclick='location.href=\"sign_up_form.php\";'>回上一頁</a>" ;
    echo "<p align='center'><a href='#' onclick='location.href=\"../b4_signup.htm\";'>回「線上報名」</a></p>" ;
}
else
  echo "<script language='JavaScript'>alert('報名成功！謝謝。'); location.href='../b4_signup.htm';</script>" ;
?>
