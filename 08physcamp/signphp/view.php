...
//  echo "Select * From $dataTableName" . $p_SQL ;
  ...
  echo "<script language=\"javascript\">function newpage() {document.form.submit();}</script><form name=\"form\" method=\"post\" action=\"sysop_un_delete.php\" target=\"newpage\" ><input type=\"hidden\" name=\"no\" value=\"", $fetch_Assoc['AutoNo'] ,"\"><input type=\"hidden\" name=\"password\" value=\"campregadmin\"><input type=\"button\" onclick=\"newpage()\" value=\"送出\"></form>";
	}
