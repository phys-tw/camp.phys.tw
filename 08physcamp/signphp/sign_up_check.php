...
if ($messenge != "") {
  ...
  echo "<p align='center'><a href='#' onclick='location.href=\"sign_up_form.php\";'>回上一頁</a></p>" ;
	    ...
	    <table width="560" border="0" cellspacing="0" cellpadding="0" style="margin-left: 10px">
          ...
          <tr align="center" valign="bottom">
            <td colspan="2" height="40">
              ...
              <input name="Reset" type="button" value="重新填寫" onclick="location.href='sign_up_form.php';">
			</td>
          </tr>
        </table>
	  </form>
