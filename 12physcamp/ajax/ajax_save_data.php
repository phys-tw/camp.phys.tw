<?php
    ...
    if ($AutoNo=='0') {
        ...
        $sql = sprintf("INSERT INTO `$table_name` (`AutoNo`, `IP`, `Name`, `Sex`, `ID`, `Birthday`, `Parent`, `Email`, `Phone`, `CellPhone`, `Address`, `School`, `Grade`, `Introduction`) VALUES (NULL, '%s', '%s', '%d', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%d', '%s')", 
